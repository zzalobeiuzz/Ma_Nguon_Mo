...
<body>
    <div class="header">
            ...
            <div class="login-cartshopping">
                <ul class="login">
                    ...
                    if (isset($_SESSION['username']) && $_SESSION['username']) {
                        echo "<li><a href ='./admin.php'>Tài khoản: " . $_SESSION['username'] . "</a></li>";
                        ...
                        if ($check_role) {
                            echo '<li><a href="index.php">Giao diện người dùng</a>';
                        } 
                    } else {
        ...
        <div class="menu">
            <li><a href="admin.php"><button id="home"><i class="fa-solid fa-house"></i></button></a></li>
            <li><a href="kho_hang.php">QUẢN LÝ SẢN PHẨM</a></li>
            <li><a href="view_order.php">QUẢN LÝ ĐƠN HÀNG</a></li>
